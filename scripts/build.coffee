...
parsed_jsons.config.longq = parsed_jsons.questions.length
parsed_jsons.config.shortq = calcShort parsed_jsons.questions
parsed_jsons.config.version = process.env.npm_package_version
