...
var actn, alle, answers, calc_score, cmdy, expr, fame, fedp, horn, init_question, max_actn, max_alle, max_cmdy, max_expr, max_fame, max_fedp, max_horn, max_perc, max_pers, max_purp, max_rela, max_sani, max_shwr, max_spos, next_question, parseQ, perc, pers, prev_question, purp, qn, questions, rela, results, sani, shwr, spos, testType;

testType = typeof exports !== "undefined" && exports !== null ? exports : this;

questions = typeof exports !== "undefined" && exports !== null ? exports : this;
...
results = function() {
  return window.location.href = "results.html" + "?a=" + calc_score(spos, max_spos) + "&b=" + calc_score(alle, max_alle) + "&c=" + calc_score(expr, max_expr) + "&d=" + calc_score(pers, max_pers) + "&e=" + calc_score(horn, max_horn) + "&f=" + calc_score(fame, max_fame) + "&g=" + calc_score(shwr, max_shwr) + "&h=" + calc_score(sani, max_sani) + "&i=" + calc_score(rela, max_rela) + "&j=" + calc_score(fedp, max_fedp) + "&k=" + calc_score(actn, max_actn) + "&l=" + calc_score(purp, max_purp) + "&m=" + calc_score(perc, max_perc) + "&n=" + calc_score(cmdy, max_cmdy) + "&z=" + testType;
};

//Fetches short questions if url substring is s
parseQ = function(fullquestions) {
  var i, j, len, len1, question, shortquestions;
...
fetch("dist/questions.json").then(function(response) {
