...
var getQueryVariable, parseR, percComp, score, setBarValue, setLabel, short, sortVal, submit, users;

short = typeof exports !== "undefined" && exports !== null ? exports : this;

users = typeof exports !== "undefined" && exports !== null ? exports : this;

score = typeof exports !== "undefined" && exports !== null ? exports : this;
...
parseR = function(data) {
  ...
  return document.getElementById("match5").innerHTML = `${users[4].value.toFixed(1)}% - ${users[4].name}`;
};

//Starts canvas element and sets darkmode to true if present
window.onload = async function() {
  var darkmode;
  await fetch("dist/users.json").then(function(response) {
  ...
  return makeUserCanvas(score, false, short, darkmode, users[0].name);
};
